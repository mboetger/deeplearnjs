...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'matmul.wast';
  var wasmBinaryFile = 'matmul.wasm';
  var asmjsCodeFile = 'matmul.temp.asm.js';
...
var real__matmul = asm["_matmul"]; asm["_matmul"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__matmul.apply(null, arguments);
};
...
var _matmul = Module["_matmul"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_matmul"].apply(null, arguments) };
