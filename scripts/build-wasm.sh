...
emcc src/math/backends/wasm/matmul.cpp -s WASM=1 -s SAFE_HEAP=1 -s TOTAL_MEMORY=16MB -s WASM_MEM_MAX=16MB -s ASSERTIONS=1 -s ALLOW_MEMORY_GROWTH=1 -s "EXTRA_EXPORTED_RUNTIME_METHODS=['ccall','cwrap']" -s EXPORTED_FUNCTIONS="['_matmul']" -o demos/benchmarks/matmul.js
