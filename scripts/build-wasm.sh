...
emcc src/math/backends/wasm/matmul.cpp -s WASM=1 -s ASSERTIONS=1 -g2 -s "EXTRA_EXPORTED_RUNTIME_METHODS=['ccall','cwrap']" -s EXPORTED_FUNCTIONS="['_matmul']" -o demos/benchmarks/matmul.js
